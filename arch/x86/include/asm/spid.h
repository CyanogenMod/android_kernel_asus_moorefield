...
enum {
	...
	INTEL_MRFL_PHONE_BTNS_PRO = 0x0004,
	INTEL_MRFL_PHONE_BTNS_ENG = 0x8004,
	INTEL_MRFL_PHONE_UNKNXXOWN = 0xFFFF
};
...
/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_BTNS */
enum {
	MRFL_PHONE_BTNS_P0,	/* BTNS FAB A, P0 */
	MRFL_PHONE_BTNS_P1,	/* BTNS FAB B, P1 */
	MRFL_PHONE_BTNS_RSVD,
	MRFL_PHONE_BTNS_UNKNOWN = 0xFFFF
};
