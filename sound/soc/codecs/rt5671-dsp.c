...
static unsigned short rt5671_dsp_init_patch_code[][2] = {
    /* patch for init time, which is auto generated from FM36600C_signoff0902.patch */
...
static unsigned short rt5671_dsp_reset_patch_code[][2] = {
    /* patch for switching mode, which is auto generated from fm36600c_signoff0902.patch */
	{0xe1, 0x0010}, {0xe2, 0x0000}, {0xe0, 0x6ac9}, /* set to dsp0 */
	{0xe1, 0x0064}, {0xe2, 0x0000}, {0xe0, 0x68c5}, /* warm reset */
	{0xe1, 0x3fa0}, {0xe2, 0x9183}, {0xe0, 0x3bcb},
	{0xe1, 0x3fb0}, {0xe2, 0x3f00}, {0xe0, 0x3bcb},
...
int rt5671_dsp_probe(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT5671_PWR_ANLG2, RT5671_PWR_PLL, RT5671_PWR_PLL);
	 */
	snd_soc_update_bits(codec, RT5671_GEN_CTRL1, RT5671_RST_DSP, 0);
	mdelay(1);
	snd_soc_update_bits(codec, RT5671_GEN_CTRL1, RT5671_RST_DSP,
	...
	rt5671_dsp_rate(codec, 24576000, 16000);
	...
	/*
		...
		snd_soc_update_bits(codec, RT5671_PWR_ANLG2, RT5671_PWR_PLL, 0);
     */
#endif
