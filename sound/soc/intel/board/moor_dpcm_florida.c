...
static int moor_florida_init(struct snd_soc_pcm_runtime *runtime)
{
	...
	moor_florida_set_bias_level(card, dapm, SND_SOC_BIAS_OFF);
...
static struct snd_soc_card snd_soc_card_moor = {
	...
	.set_bias_level = moor_florida_set_bias_level,
	.set_bias_level_post = moor_florida_set_bias_level_post,
...
{
	pr_info("Merrifield Machine Driver mrfld_wm8280 registerd\n");
...
MODULE_ALIAS("platform:mrfld_florida");
