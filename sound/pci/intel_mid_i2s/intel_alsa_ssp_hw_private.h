...
const struct intel_mid_i2s_settings
	a_alsa_ssp_stream_settings[INTEL_ALSA_SSP_SND_CARD_MAX_DEVICES] = {
		{
#ifdef CONFIG_SND_INTEL_ALSA_SSP_MASTER_MODE
		/* BT configuration in master */
		  ...
		  .master_mode_standard_freq = SSP_FRM_FREQ_8_000,
		  .data_size = 16,
		...
		/* BT configuration in slave */
		  ...
		  .ssp_active_tx_slots_map = 0x01,
		  .ssp_active_rx_slots_map = 0x01
#endif /* SND_INTEL_ALSA_SSP_MASTER_MODE */
		},
		{
		/* FM configuration (slave) */
		  .mode = SSP_IN_NETWORK_MODE,
		  .rx_fifo_interrupt = SSP_RX_FIFO_OVER_INT_ENABLE,
		  .tx_fifo_interrupt = SSP_TX_FIFO_UNDER_INT_ENABLE,
		  .frame_format = PSP_FORMAT,
		...
		{
#ifdef CONFIG_SND_INTEL_ALSA_SSP_BUILTIN_MASTER_MODE
		/* BUILTIN configuration (I2S master 2x16bits 48Khz) for VOIP */
		  .mode = SSP_IN_NETWORK_MODE,
		  .rx_fifo_interrupt = SSP_RX_FIFO_OVER_INT_ENABLE,
		  .tx_fifo_interrupt = SSP_TX_FIFO_UNDER_INT_ENABLE,
		  .frame_format = PSP_FORMAT,
		  ...
		  .ssp_active_tx_slots_map = 0x01,
		  .ssp_active_rx_slots_map = 0x01
#else /* CONFIG_SND_INTEL_ALSA_SSP_BUILTIN_MASTER_MODE */
		/* BUILTIN configuration (slave PCM) for VOIP */
		  .mode = SSP_IN_NETWORK_MODE,
		  .rx_fifo_interrupt = SSP_RX_FIFO_OVER_INT_ENABLE,
		  .tx_fifo_interrupt = SSP_TX_FIFO_UNDER_INT_ENABLE,
		  .frame_format = PSP_FORMAT,
		  ...
		  .ssp_active_tx_slots_map = 0x01,
		  .ssp_active_rx_slots_map = 0x01
#endif /* CONFIG_SND_INTEL_ALSA_SSP_BUILTIN_MASTER_MODE */
