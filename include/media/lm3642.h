...
#define LM3642_VALUE_TO_PERCENT(v, step)     (((((unsigned long)((v)+1))*(step))+50)/100)
#define LM3642_PERCENT_TO_VALUE(p, step)     (((((unsigned long)(p))*100)+((step)>>1))/(step)-1)
...
#define LM3642_FLASH_STEP	\
	((100ul*(LM3642_MAX_PERCENT)+((LM3642_FLASH_MAX_LVL+1)>>1))/((LM3642_FLASH_MAX_LVL+1)))
...
((100ul*(LM3642_MAX_PERCENT)+((LM3642_TORCH_MAX_LVL+1)>>1))/((LM3642_TORCH_MAX_LVL+1)))
...
((100ul*(LM3642_MAX_PERCENT)+((LM3642_INDICATOR_MAX_LVL+1)>>1))/((LM3642_INDICATOR_MAX_LVL+1)))
