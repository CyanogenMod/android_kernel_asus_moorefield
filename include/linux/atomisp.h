...
enum atomisp_ext_isp_id {
    EXT_ISP_CID_SATURATION = 0,
    EXT_ISP_CID_CONTRAST,
    EXT_ISP_CID_ISO,
    EXT_ISP_CID_EV,
    EXT_ISP_CID_SHUTTER_SPEED,
    EXT_ISP_CID_FLICKER,
    EXT_ISP_CID_AE_SCENE_MODE,
    EXT_ISP_CID_FLASH_MODE,
    EXT_ISP_CID_GET_METERING_MODE,
    EXT_ISP_CID_SET_METERING_MODE,
    EXT_ISP_CID_TOUCH_AE_POSX,
    EXT_ISP_CID_TOUCH_AE_POSY,
    EXT_ISP_CID_TOUCH_POSX,
    EXT_ISP_CID_TOUCH_POSY,
    EXT_ISP_CID_TOUCH_WIDTH,
    EXT_ISP_CID_TOUCH_HEIGHT,
    EXT_ISP_CID_ZOOM,
    EXT_ISP_CID_FOCUS_EXECUTION,
    EXT_ISP_CID_FOCUS_MODE,
    EXT_ISP_CID_GSENSOR_X,
    EXT_ISP_CID_GSENSOR_Y,
    EXT_ISP_CID_GSENSOR_Z,
    EXT_ISP_CID_WB_MANUAL,
    EXT_ISP_CID_COLOR_TEMPERATURE,
    ...
    EXT_ISP_M10MO_SET_CAPTURE_MODE,
    EXT_ISP_CID_LOWLIGHT,
    EXT_ISP_CID_EIS_MODE,
