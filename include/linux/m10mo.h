...
#define M10MO_IRQ_COMMAND_AVAILABDLE 0
#define M10MO_ZOOMING                1
#define M10MO_FOCUSING               2
#define M10MO_AF_CANCELING           3
#define M10MO_OPTICAL_ZOOM_CANCELING   4
#define M10MO_DIGITAL_ZOOMING        5
#define M10MO_NOT_LENS_RELATED_BUSYING 6
struct m10mo_focus_data_t {
    u32 f_number;
	u32 focal_len;
};
...
//	struct mutex m10mo_lens_state_machine_lock;
	...
	volatile u8 m10mo_request_cmd_lock_flag;
	volatile u8 lock_i2c_write_flag;
	volatile u32 m10mo_request_cmd_lens_data;
    struct workqueue_struct *lens_wq;
...
typedef enum {
	...
	M10MO_IRQ_EVENT = 2
} m10mo_state_machine_event_t;

enum M10MO_LENS_STATE_MACHINE {
    LENS_IDLE = 0,
//=== Focusing related ===//
	FOCUSING = 1,
...
//=========== M10MO PARAMETER MODE ============//
	...
	M10MO_HEAD_HALF_HOME_SEARCHING_MODE,
...
//=========== M10MO MONITOR MODE ============//
    ...
    M10MO_MANUAL_FOCUS,
    M10MO_MANUAL_ZOOM,
	M10MO_ASUS_ZOOM_CANCEL,
	M10MO_ASUS_FOCUS_CANCEL,
	M10MO_BOTTOM_HALF_HOME_SEARCHING_MODE
};
enum M10MO_MODE {
...
extern const struct m10mo_focus_data_t m10mo_focus_data_table[];
