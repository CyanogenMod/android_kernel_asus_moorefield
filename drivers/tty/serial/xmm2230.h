/****************************************************************************
 *
 * Driver for the xm2230 spi modem.
 *
...
#define IFX_SPI_TRANSFER_SIZE		2176
#define IFX_SPI_TRANSFER_SIZE_RM		2048
#define IFX_SPI_FIFO_SIZE		4352
...
#define IFX_SPI_STATE_IPC_RECOVER	5
#define IFX_SPI_STATE_IPC_HANGUP	6
...
#define IFX_SPI_PAYLOAD_SIZE_RM		(IFX_SPI_TRANSFER_SIZE_RM - \
							IFX_SPI_HEADER_OVERHEAD)
...
struct ifx_spi_device {
	...
	unsigned long flags;
	unsigned long frame_len_flag_rm;
	dma_addr_t rx_dma;
	dma_addr_t tx_dma;
...
#define MR_COMPLETE	2
	...
	unsigned char spi_ipc_timeout_count;
};
