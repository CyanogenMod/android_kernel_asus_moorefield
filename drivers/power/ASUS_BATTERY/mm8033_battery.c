...
static int mm8033_checkdevice(struct mm8033_chip *chip)
{
	...
	struct mm8033_batparams params_nvt = {
	{
        ...
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0x04, 0x2F, 0x01, 0x66, 0x30, 0x00, 0x72, 0x06,
        ...
        0x4B, 0x78, 0x78, 0x09, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0x30, 0x74, 0x0F, 0xFF, 0x03, 0x00, 0x04, 0x01,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	},
#ifdef I2CLOW_RESTART
		1,			// enable i2c_sh
	...
	struct mm8033_batparams params_simplo = {
	{
        ...
        0x4B, 0x78, 0x78, 0x09, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0x40, 0x7A, 0x0F, 0xFF, 0x04, 0x00, 0x04, 0x01,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	},
#ifdef I2CLOW_RESTART
		1,			// enable i2c_sh
	...
	struct mm8033_batparams params_celxpert = {
	{
        ...
        0x4B, 0x78, 0x78, 0x09, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0x30, 0x64, 0x0F, 0xFF, 0x05, 0x00, 0x04, 0x01,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	},
#ifdef I2CLOW_RESTART
		1,          // enable i2c_sh
...
{
	int volt = mm8033_read_reg(g_mm8033_chip->client, REG_VOLTAGE);
...
{
	int temp = mm8033_read_reg(g_mm8033_chip->client, REG_TEMPERATURE);
...
{
	int fcc = mm8033_read_reg(g_mm8033_chip->client, REG_FULL_CHARGE_CAPACITY);
...
{
	int rm = mm8033_read_reg(g_mm8033_chip->client, REG_REM_CAPACITY);
