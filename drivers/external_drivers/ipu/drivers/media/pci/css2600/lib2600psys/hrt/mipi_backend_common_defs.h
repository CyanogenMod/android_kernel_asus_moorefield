...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NEW CSIX PACKET HEADER
//
#define MIPI_BE_LENGTH_LSB    	  0
#define MIPI_BE_LENGTH_MSB    		15
#define MIPI_BE_DTYPE_LSB       	16
#define MIPI_BE_DTYPE_MSB       	28
#define MIPI_BE_SYNC_LSB        	29
#define MIPI_BE_SYNC_MSB        	30
#define MIPI_BE_SENSOR_TYPE_BIT 	31

#define MIPI_BE_LENGTH_WIDTH      (MIPI_BE_LENGTH_MSB-MIPI_BE_LENGTH_LSB+1)
#define MIPI_BE_DTYPE_WIDTH       (MIPI_BE_DTYPE_MSB-MIPI_BE_DTYPE_LSB+1)
#define MIPI_BE_SYNC_WIDTH        (MIPI_BE_SYNC_MSB-MIPI_BE_SYNC_LSB+1)


#define _HRT_CSS_RECEIVER_2400_CSI_LENGTH_IDX     0  
#define _HRT_CSS_RECEIVER_2400_CSI_LENGTH_BITS   16

#define _HRT_CSS_RECEIVER_2400_CSI_DTYPE_IDX     16 
#define _HRT_CSS_RECEIVER_2400_CSI_DTYPE_BITS    13

#define _HRT_CSS_RECEIVER_2400_CSI_SYNC_IDX      29
#define _HRT_CSS_RECEIVER_2400_CSI_SYNC_BITS     2

#define _HRT_CSS_RECEIVER_2400_CSI_STYPE_IDX     31 
#define _HRT_CSS_RECEIVER_2400_CSI_STYPE_BITS     1

#define _HRT_CSS_RECEIVER_2400_CSI_SID_IDX       32 
#define _HRT_CSS_RECEIVER_2400_CSI_SID_BITS       4
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Definition of data format ID at the interface CSS_receiver capture/acquisition units */
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_SOF                  256   // 1 0000 0000   frame start                                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_EOF                  257   // 1 0000 0001   frame end                                        
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_SOL                  258   // 1 0000 0010   line start                                       
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_EOL                  259   // 1 0000 0011   line end                                         
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH1              264   // 1 0000 1000   Generic Short Packet Code 1                        
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH2              265   // 1 0000 1001   Generic Short Packet Code 2                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH3              266   // 1 0000 1010   Generic Short Packet Code 3                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH4              267   // 1 0000 1011   Generic Short Packet Code 4                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH5              268   // 1 0000 1100   Generic Short Packet Code 5                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH6              269   // 1 0000 1101   Generic Short Packet Code 6                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH7           	 270   // 1 0000 1110   Generic Short Packet Code 7                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_SH8              271   // 1 0000 1111   Generic Short Packet Code 8  
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_Emb               	 274   // 1 0001 0010   embedded eight bit non image data    

#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_LP1 						 275	 // 1 0001 0011   Generic Long Packet Code 1          	 
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_LP2              276   // 1 0001 0100   Generic Long Packet Code 2
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_LP3              277   // 1 0001 0101   Generic Long Packet Code 3  
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_LP4              278	 // 1 0001 0110   Generic Long Packet Code 4
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_GEN_LP5              279   // 1 0001 0111   Generic Long Packet Code 5

#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV420_8          	 280   // 1 0001 1000   YUV420 8-bit                                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV420_10         	 281   // 1 0001 1001 	YUV420 10-bit                                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV420_8L         	 282   // 1 0001 1010   YUV420 8-bit legacy                               
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV420_8_CSPS     	 284   // 1 0001 1100   YUV420 8-bit (Chroma Shifted Pixel Sampling)      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV420_10_CSPS    	 285   // 1 0001 1101   YUV420 10-bit (Chroma Shifted Pixel Sampling)  
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV422_8          	 286   // 1 0001 1110   YUV422 8-bit                                      
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_YUV422_10         	 287   // 1 0001 1111   YUV422 10-bit                                     
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RGB444            	 288   // 1 0010 0000   RGB444                                            
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RGB555            	 289   // 1 0010 0001   RGB555                                            
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RGB565            	 290   // 1 0010 0010   RGB565                                            
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RGB666            	 291   // 1 0010 0011   RGB666                                            
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RGB888            	 292   // 1 0010 0100   RGB888                                            
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW6                 296   // 1 0010 1000   RAW6                                              
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW7              	 297   // 1 0010 1001   RAW7                                              
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW8                 298   // 1 0010 1010   RAW8                                              
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW10                299   // 1 0010 1011   RAW10                                             
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW12                300   // 1 0010 1100   RAW12                                             
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW14                301   // 1 0010 1101   RAW14                                             
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_1         	 304   // 1 0011 0000   JPEG [User Defined 8-bit Data Type 1]            
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_2         	 305   // 1 0011 0001   User Defined 8-bit Data Type 2                   
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_3         	 306   // 1 0011 0010   User Defined 8-bit Data Type 3                   
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_4         	 307   // 1 0011 0011   User Defined 8-bit Data Type 4                   
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_5         	 308   // 1 0011 0100   User Defined 8-bit Data Type 5                   
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_6         	 309   // 1 0011 0101   User Defined 8-bit Data Type 6                   
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_7         	 310   // 1 0011 0110   User Defined 8-bit Data Type 7                   
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_USR_DEF_8         	 311   // 1 0011 0111   User Defined 8-bit Data Type 8                   
              
/* used reseved mipi positions for these */
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW16             	 312   // 1 0010 1110 
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW18             	 313   // 1 0010 1111 
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW18_2           	 314   // 1 0010 0101 
#define _HRT_CSS_RECEIVER_2400_DATA_FORMAT_ID_RAW18_3           	 315   // 1 0010 0110 

//_HRT_CSS_RECEIVER_2400_FMT_TYPE_CUSTOM 63
#define _HRT_MIPI_BACKEND_FMT_TYPE_CUSTOM                       	 319   // 1 0011 1111

// CSI-3 DTYPES
#define _HRT_CSS_RECEIVER_2600_DTYPE_CSI3_PRE_IMAGE_Emb	           513	 // 8-bit 	embedded data preceeding image data  						
#define _HRT_CSS_RECEIVER_2600_DTYPE_CSI3_POST_IMAGE_Emb           520	 // 8-bit 	embedded data following image data 
#define _HRT_CSS_RECEIVER_2600_DTYPE_CSI3_JPEG1 									 544	 // 8-bit encoded JPEG1 - interchange data
#define _HRT_CSS_RECEIVER_2600_DTYPE_CSI3_JPEG2 									 545	 // 8-bit encoded JPEG2 - JFIF data
#define _HRT_CSS_RECEIVER_2600_DTYPE_CSI3_JPEG3 									 546	 // 8-bit encoded JPEG3 - EXIF			

#define _HRT_CSS_RECEIVER_2600_DTYPE_CSI3_RAW16 									 528   // RAW16 CSI3

#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_10_8_10_P1					 560	
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_10_8_10_P2					 561
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_10_7_10_P1					 562
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_10_7_10_P2					 563
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_10_6_10_P1					 564
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_10_6_10_P2					 565
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_12_8_12_P1					 566
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_12_8_12_P2					 567	
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_12_7_12_P1           568   
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_12_7_12_P2           569
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_12_6_12_P1           570
#define _HRT_CSS_RECEIVER_2600_DATA_FORMAT_ID_12_6_12_P2           571   
