...
/*
 *Calculation for manual size check for struct ia_css_terminal_manifest_s
 */
...
#define SIZE_OF_PARAM_TERMINAL_MANIFEST_STRUCT_IN_BITS \
	...
	+ IA_CSS_UINT32_T_BITS \
	+ IA_CSS_UINT8_T_BITS \
	+ (IA_CSS_UINT8_T_BITS * 3))
/*
 * Inherited parameter terminal class
 */
struct ia_css_param_terminal_manifest_s {
	ia_css_terminal_manifest_t		base;											/**< Parameter terminal base */
	uint32_t                        section_offset;
	uint8_t							section_count;									/**< Number of parameter sections on this terminal */
	uint8_t							reserved[3];
};
...
extern int ia_css_terminal_manifest_init(ia_css_terminal_manifest_t *blob,
