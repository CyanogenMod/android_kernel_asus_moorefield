...
* Rev- 1.0 01/20/2013
**************************************************************************/
#ifndef _CSS2600_SUBACESSS_IOCTL_H_
#define _CSS2600_SUBACESSS_IOCTL_H_
...
#define VIED_SUBACCESS_IOC_MEMORY_MAP_INITIALIZE	_IO(VIED_SUBACCESS_IOC_MAGIC, 5)
#define VIED_SUBACCESS_IOC_MEMORY_MAP	_IO(VIED_SUBACCESS_IOC_MAGIC, 6)
#define VIED_SUBACCESS_IOC_MEMORY_ALLOC_INITIALIZE	_IO(VIED_SUBACCESS_IOC_MAGIC, 7)
...
#define VIED_SUBACCESS_IOC_MEMORY_ALLOC_UNINITIALIZE	_IO(VIED_SUBACCESS_IOC_MAGIC, 10)
